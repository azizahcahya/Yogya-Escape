...
<div class="col-lg-8">
  <form method="post" action="/dashboard/guide/{{$post->id}}" enctype="multipart/form-data">
    @method('put')
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('noHp') is-invalid @enderror" id="noHp" name="noHp" value="{{ old('noHp',  $post->noHp) }}">
        @error('noHp')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
